...
def generar_word_asis():
    ...
    add_h2("2.2. Encuestas de Factores de Riesgo (4ª ENFR/UNTREF), Egresos Hospitalarios y Carga de Morbilidad")
    add_p("Más allá de los indicadores vitales básicos, el análisis de la carga de morbilidad distrital y las prevalencias de riesgo en Tres de Febrero se sustenta en tres relevamientos estadísticos e institucionales de fundamental jerarquía metodológica:", "Estudios y Encuestas Epidemiológicas de Referencia:")
    add_p("1. 4ª Encuesta Nacional de Factores de Riesgo (ENFR — INDEC / Ministerio de Salud y UNTREF): La Universidad Nacional de Tres de Febrero (UNTREF) tuvo un rol protagónico en la ejecución y coordinación de las mediciones físicas y bioquímicas de campo en el Conurbano Bonaerense para la 4ª ENFR. Sus resultados para la subregión del Gran Buenos Aires demuestran un peso preponderante de las Enfermedades Crónicas No Transmisibles (ECNT): más del 60% de la población adulta presenta sobrepeso u obesidad, el 34,6% registra hipertensión arterial conocida o en tratamiento, y se evidencia una marcada prevalencia de sedentarismo y baja actividad física. Estos hallazgos otorgan un sustento epidemiológico decisivo a las intervenciones preventivas municipales como '3F Cuida tu Salud' y la descentralización comunitaria de las 'Plazas Saludables'.\n\n2. Perfil de Egresos Hospitalarios y Causas de Morbi-Mortalidad (DEIS / SISA Región VII): Los registros oficiales de egresos y demanda de internación en los efectores públicos interconectados del partido (Hospitales Bocalandro, Carrillo y red ambulatoria) indican que la carga de morbilidad grave se concentra en tres ejes determinantes:\n   • Enfermedades del Sistema Circulatorio (1ª causa de mortalidad general): Cardiopatías isquémicas, insuficiencia cardíaca y accidentes cerebrovasculares (ACV), estrechamente vinculados a la prevalencia de hipertensión arterial.\n   • Enfermedades del Sistema Respiratorio (2ª causa domiciliaria e internación estacional): Neumonías, EPOC e Infecciones Respiratorias Agudas Bajas (IRAB), cuya severidad es significativamente mayor en las áreas del corredor norte con déficit de infraestructura habitacional (NBI).\n   • Causas Externas y Accidentología en Vía Pública: Por su entramado geográfico atravesado por arterias de tránsito pesado y circulación rápida (Av. Eva Perón / ex Ruta 8, Gral. Paz, Camino del Buen Ayre y Acceso Oeste), la accidentología vial representa un factor crítico en la demanda de urgencias en la vía pública, consolidando la necesidad de la interoperabilidad continua entre el SAME 107 municipal y la Base SIES R7 del Hospital Carrillo.\n\n3. Diagnósticos ASIS Situados y Residencias de Medicina General (FAMG / CAPS Municipales): Diversos estudios de diagnóstico microterritorial producidos por las Residencias de Medicina General y Familiar de la Provincia de Buenos Aires en áreas programáticas de CAPS (ej. CAPS 6 Caseros Centro / Barrio El Mercado y zonas de influencia del Bocalandro) advierten una alta tasa de polimedicalización y descompensación de patologías metabólicas en adultos mayores (universo que abarca al 20,8% del partido), así como demandas emergentes en salud mental adolescente, consejería en salud sexual e infecciones de transmisión sexual (ITS) en establecimientos educativos.", "Evidencia de Campo y Morbilidad Situada:")
    add_fuente_nota("4ª Encuesta Nacional de Factores de Riesgo (INDEC / Ministerio de Salud de la Nación y Universidad Nacional de Tres de Febrero - UNTREF), Registros de Egresos Hospitalarios DEIS/SISA, Dirección de Información en Salud (PBA) e Informes de Diagnóstico Territorial de Residencias en Medicina General (FAMG/CAPS Tres de Febrero).")
    ...
    add_h2("D. Campañas Sanitarias, Programas Municipales y Canales de Atención Distrital")
    add_p("La Secretaría de Salud y Gestión Operativa del Municipio de Tres de Febrero implementa de manera activa una red de programas territoriales, campañas preventivas permanentes y plataformas digitales orientadas al tamizaje temprano, la inmunización comunitaria y el acceso ágil de la población al sistema prestacional (disponibles en el portal web oficial www.tresdefebrero.gov.ar/salud/):", "Estrategias Sanitarias y Programas Distritales:")
    add_p("1. Portal de Autogestión de Turnos (Mi3F) y Telemedicina: Plataforma web interactiva (turnos.tresdefebrero.gob.ar/home) que centraliza el otorgamiento de turnos protegidos en los 13 CAPS municipales. Se complementa con consultorios virtuales de Telemedicina para la atención rápida de patologías leves sin traslado de los vecinos y un Call Center de orientación sanitaria distrital.\n\n2. SAME Tres de Febrero (107 Municipal) & SIES: Sistema propio de Atención Médica de Emergencias prehospitalario operativo las 24 horas a través de la línea gratuita 107. Dispone de unidades de terapia intensiva móvil georreferenciadas que trabajan en red y despacho articulado con la Base SIES de la Región Sanitaria VII.\n\n3. Campañas de Vacunación Integral (#YoPongoElBrazo): Plan descentralizado en todos los CAPS y operativos móviles escolares/barriales (tresdefebrero.gov.ar/yopongoelbrazo/). Asegura la cobertura total del Calendario Nacional, la aplicación de la dosis extra del Nuevo Esquema de Vacuna Triple Viral (Sarampión, Rubéola y Paperas), vacunación obligatoria en embarazadas (VRS, Triple Bacteriana Acelular, Antigripal) y prevención frente a Hepatitis B/C y Tuberculosis.\n\n4. 3F Cuida tu Salud & Plazas Saludables: Programa itinerante de promoción de la salud en espacios verdes públicos de las distintas localidades distritales (tresdefebrero.gov.ar/3fcuidatusalud/ y plazassaludables). Brinda controles de tensión arterial, glucemia capilar, medición de peso e índice de masa corporal (IMC), promoviendo la actividad física y hábitos saludables para reducir el impacto de enfermedades crónicas no transmisibles.\n\n5. Vigilancia Arbovirosis (Dengue, Zika, Chikungunya) & Zoonosis: Estrategia territorial permanente de descacharrado, control de foco y fumigación espacial contra el mosquito Aedes aegypti (tresdefebrero.gov.ar/dengue/). Se articula con las campañas de Sanidad Animal ('Mascotas de 3F') mediante vacunación antirrábica comunitaria y cirugías de castración gratuitas en plazas.\n\n6. Prevención de Enfermedades Crónicas y Tamizaje Especializado: Atención gratuita e integral para pacientes diabéticos (PRODIABA con entrega virtual continua de insumos y fármacos), detección precoz del cáncer de cuello de útero (PAP y Test de VPH en todos los CAPS), talleres escolares de salud integral para adolescentes, y diagnóstico odontológico digitalizado por Pantomógrafo de Alta Complejidad en el Hospital Di Próspero.", "Detalle de Programas Institucionales:")
    add_fuente_nota("Portal Web Oficial de la Secretaría de Salud y Gestión Operativa de la Municipalidad de Tres de Febrero (https://www.tresdefebrero.gov.ar/salud/ y subportales asociados, 2026).")
    ...
    bibliografia_items = [
        ...
        ("UNTREF / INDEC — 4ª Encuesta Nacional de Factores de Riesgo (ENFR):",
         "Universidad Nacional de Tres de Febrero (UNTREF) y Ministerio de Salud de la Nación. Mediciones antropométricas, prevalencia de sobrepeso/obesidad (>60%), hipertensión arterial (34,6%) y sedentarismo en adultos del Conurbano Bonaerense y Región Sanitaria VII.\nEnlace de acceso directo: https://www.untref.edu.ar/ y https://www.indec.gob.ar/indec/web/Nivel4-Tema-4-32-68"),
        ("DEIS / DIS PBA — Perfil de Egresos Hospitalarios y Morbilidad:",
         "Dirección de Estadísticas e Información en Salud y Dirección de Información en Salud (PBA). Carga de morbi-mortalidad domiciliaria y hospitalaria: 1º Sistema Circulatorio, 2º Sistema Respiratorio (IRAB/Neumonías estacionales) y 3º Causas Externas/Accidentología Vial en el Partido de Tres de Febrero.\nEnlace de acceso directo: https://deis.msal.gov.ar/ e informes provinciales."),
        ("Observatorio del Conurbano Bonaerense (UNGS / OIDBA):",
         "Instituto del Conurbano (UNGS) y Observatorio de Investigación Demográfica de la Provincia de Buenos Aires. Series socioterritoriales e índices de vulnerabilidad socio-sanitaria en los partidos del AMBA y Tres de Febrero.\nEnlace de acceso directo: http://observatorioconurbano.ungs.edu.ar/ y https://oidba.ar/"),
        ("Residencias en Medicina General y Familiar (FAMG / CAPS Tres de Febrero):",
         "Federación Argentina de Medicina General y residencias interhospitalarias en red con los CAPS municipales. Estudios cualitativos situados de polimedicalización en adultos mayores y salud integral adolescente en escuelas públicas distritales.\nEnlace de acceso directo: https://famg.org.ar/"),
